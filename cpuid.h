...
#define PRINT_FEATURE(_flags, _feature) if (_flags & CPUID_LEAF_1_##_feature) cprintf(#_feature " ");
#define PRINT_SEFEATURE(_flags, _feature) if (_flags & CPUID_LEAF_7_##_feature) cprintf(#_feature " ");
